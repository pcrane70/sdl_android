 ...
 */
     ...
     */
    VEHICLEDATA_MYKEY,
    VEHICLEDATA_GPS_ARRAY,
    VEHICLEDATA_SPEED_ARRAY,
    VEHICLEDATA_RPM_ARRAY,
    VEHICLEDATA_FUELLEVEL_ARRAY,
    VEHICLEDATA_FUELLEVEL_STATE_ARRAY,
    VEHICLEDATA_EXTERNTEMP_ARRAY,
    VEHICLEDATA_PRNDL_ARRAY,
    VEHICLEDATA_TIREPRESSURE_ARRAY,
    VEHICLEDATA_ENGINETORQUE_ARRAY,
    VEHICLEDATA_ACCPEDAL_ARRAY,
    VEHICLEDATA_FUELREMAININGRANGE_ARRAY,
    VEHICLEDATA_BRAKEPEDALPOSITION_ARRAY,
    VEHICLEDATA_STEERINGWHEELANGLE_ARRAY,
    VEHICLEDATA_ACCELEROMETER_ARRAY,
    VEHICLEDATA_GYROSCOPE_ARRAY,
    VEHICLEDATA_WHEELSPEEDS_ARRAY,
    ;
	/**
